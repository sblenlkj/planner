...
class ModularMonolithQueryExecutionEnginePort(Protocol):
    async def handle(
        self,
        *,
        query: Query,
...
class ModularMonolithQueryExecutionEngine(
    ModularMonolithQueryExecutionEnginePort,
        ...
        *,
        ...
        if not isinstance(handler, AbstractQueryHandler):
            raise RuntimeError(
                ...
                "ModularMonolithQueryExecutionEngine currently supports only "
                "AbstractQueryHandler. "
