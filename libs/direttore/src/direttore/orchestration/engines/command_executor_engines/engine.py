...
class CommandExecutionEnginePort(Protocol):
        ...
        *,
        ...
        if not isinstance(handler, AbstractCommandHandler):
            raise RuntimeError(
                ...
                "CommandExecutionEngine currently supports only "
                "AbstractCommandHandler. "
